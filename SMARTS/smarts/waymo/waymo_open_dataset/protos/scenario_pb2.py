...
_REQUIREDPREDICTION_DIFFICULTYLEVEL = _REQUIREDPREDICTION.enum_types_by_name[
    "DifficultyLevel"
]
ObjectState = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "smarts.waymo.waymo_open_dataset.protos.scenario_pb2"
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _OBJECTSTATE._serialized_start = 128
    _OBJECTSTATE._serialized_end = 314
    _TRACK._serialized_start = 317
    _TRACK._serialized_end = 547
    _TRACK_OBJECTTYPE._serialized_start = 446
    _TRACK_OBJECTTYPE._serialized_end = 547
    _DYNAMICMAPSTATE._serialized_start = 549
    _DYNAMICMAPSTATE._serialized_end = 631
    _REQUIREDPREDICTION._serialized_start = 634
    _REQUIREDPREDICTION._serialized_end = 806
    _REQUIREDPREDICTION_DIFFICULTYLEVEL._serialized_start = 753
    _REQUIREDPREDICTION_DIFFICULTYLEVEL._serialized_end = 806
    _SCENARIO._serialized_start = 809
    _SCENARIO._serialized_end = 1185
